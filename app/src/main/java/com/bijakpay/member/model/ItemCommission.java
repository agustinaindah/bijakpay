...
public class ItemCommission implements Serializable {
    ...
    @Expose
    private String cashbackLogCashbackId;
    ...
    @SerializedName("cashback_log_refund_desc")
    @Expose
    private Object cashbackLogRefundDesc;
    @SerializedName("cashback_log_is_refund")
    @Expose
    private String cashbackLogIsRefund;
    ...
    public String getCashbackLogCashbackId() {
        return cashbackLogCashbackId;
    }

    public void setCashbackLogCashbackId(String cashbackLogCashbackId) {
    ...
    public Object getCashbackLogRefundDesc() {
        return cashbackLogRefundDesc;
    }

    public void setCashbackLogRefundDesc(Object cashbackLogRefundDesc) {
        this.cashbackLogRefundDesc = cashbackLogRefundDesc;
    }

    public String getCashbackLogIsRefund() {
        return cashbackLogIsRefund;
    }

    public void setCashbackLogIsRefund(String cashbackLogIsRefund) {
        this.cashbackLogIsRefund = cashbackLogIsRefund;
    }
}
