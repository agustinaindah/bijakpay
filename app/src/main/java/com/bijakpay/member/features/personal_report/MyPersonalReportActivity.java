...
public class MyPersonalReportActivity extends BaseActivity implements TabLayout.OnTabSelectedListener{
    ...
    private MyPersonalReportFragmentAdapter mAdapter;
    ...
    protected void onActivityCreated(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Personal Report");

        mAdapter = new MyPersonalReportFragmentAdapter(getSupportFragmentManager());
