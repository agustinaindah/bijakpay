...
public class BussinesReportAdapter extends RecyclerView.Adapter<BussinesReportAdapter.ViewHolder> {

    private Context context;
    private List<Simple> simples;

    public BussinesReportAdapter(Context context) {
    ...
    @Override
    public BussinesReportAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = ViewHelper.inflateView(parent, R.layout.item_list);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(BussinesReportAdapter.ViewHolder holder, int position) {
            ...
            public void onClick(View view) {
                ...
                switch (list.getKey()){
                    case Consts.MEMBERSHIP:
                        fragment = ReportMembershipFragment.newInstance();
                        break;
                    case Consts.ROYALTY:
                        fragment = ReportRoyaltyFragment.newInstance();
                        break;
                    case Consts.ROYALTY_REFUND:
                        fragment = ReportRefundRoyaltyFragment.newInstance();
                        break;
                    case Consts.CARD_STOCK:
                        fragment = ReportStockCardFragment.newInstance();
                        break;
                }
                try {
                    if (fragment !=null){
