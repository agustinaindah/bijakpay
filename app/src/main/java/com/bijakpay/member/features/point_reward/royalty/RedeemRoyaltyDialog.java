package com.bijakpay.member.features.point_reward.royalty;
...
public class RedeemRoyaltyDialog extends DialogFragment implements RedeemBonusPresenter.View{
    ...
    public static RedeemRoyaltyDialog newInstance() {
        Bundle args = new Bundle();
        RedeemRoyaltyDialog fragment = new RedeemRoyaltyDialog();
        ...
        builder.setView(view)
                ...
                .setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        RedeemRoyaltyDialog.this.getDialog().cancel();
                    }
                });
    ...
    private JsonObject getInput(){
        ...
        try {
            jsonRequest.addProperty("type","royalty");
    ...
    public void success(JsonObject jsonRes) {
        Helper.createAlert(getActivity(), Consts.STR_INFO, "Berhasil", false, new CallbackInterface() {
            @Override
