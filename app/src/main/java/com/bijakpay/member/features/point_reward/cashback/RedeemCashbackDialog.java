package com.bijakpay.member.features.point_reward.cashback;
...
public class RedeemCashbackDialog extends DialogFragment implements RedeemBonusPresenter.View {

    // TODO: 22/06/2017 sabar sek yaa
    ...
    String strLoading;
    @BindString(R.string.label_cashback)
    String strTitleCashback;
    ...
    public static RedeemCashbackDialog newInstance() {
        Bundle args = new Bundle();
        RedeemCashbackDialog fragment = new RedeemCashbackDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(view)
                .setTitle(strTitleCashback)
                .setPositiveButton(android.R.string.ok, null)
                .setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        RedeemCashbackDialog.this.getDialog().cancel();
                    }
                });
    ...
    private JsonObject getInput(){
        ...
        try {
            jsonRequest.addProperty("type","cashback");
